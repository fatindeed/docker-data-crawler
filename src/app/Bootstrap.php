...
class Bootstrap {
	...
	public function __construct() {
		...
		$loader_class_name = __NAMESPACE__.'\\'.$module.'\\Loader';
		if(!class_exists($loader_class_name)) {
			trigger_error('Invalid module for '.$action.PHP_EOL, E_USER_ERROR);
		}
		$is_arg = true;
		$args = $params = [];
		...
		$loader = new $loader_class_name($params);
		return call_user_func_array([$loader, $method], $args);
	}
